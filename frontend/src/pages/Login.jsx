  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        <span style={styles.pill}>Welcome back</span>
        <h1 style={styles.title}>Login to Schedula</h1>
        <p style={styles.subtitle}>Access your event dashboard, registrations, and analytics.</p>
        ...
        <p style={styles.footerText}>
          New to Schedula? <Link to="/signup" style={styles.link}>Create an account</Link>
        </p>
      </div>
    </div>
  );
